...
public static class Mapping
{
    ...
    public static SaveItemRequest ToSaveItemRequest(this PluItemDto plu, ZraApiOptions apiOptions)
    {
        return new SaveItemRequest
        {
            ...
            vatCatCd = GetTaxTypeCode(apiOptions.TaxMappings, plu.SalesGroup),
        ...
        return
            response
                ...
                .Select(x => new PurchaseDto
                {
                    ...
                    ConfirmedDate = DateTime.ParseExact(x.cfmDt, "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture),
                    SalesDate = DateTime.ParseExact(x.salesDt, "yyyyMMdd", CultureInfo.InvariantCulture),
                    StockReleaseDate = x.stockRlsDt is not null ? DateTime.ParseExact(x.stockRlsDt, "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture) : null,
    ...
    public static SavePurchaseRequest MapToSavePurchaseRequest(this PurchaseDto purchase, ZraApiOptions apiOptions)
    {
        return new SavePurchaseRequest
        {
            ...
            pchsDt = purchase.SalesDate.ToString("yyyyMMdd"),
